...
public class Key
{
    public const string PACK1 = "app31_pack1";
    public const string PACK2 = "app31_pack2";
    public const string PACK3 = "app31_pack3";
    public const string PACK4 = "app31_pack4";


    public const string PACK1_REGISTER = "register_app31_pack1";
    public const string PACK2_REGISTER = "register_app31_pack2";
    public const string PACK3_REGISTER = "register_app31_pack3";
    public const string PACK4_REGISTER = "register_app31_pack4";
    public const string PACK5_REGISTER = "register_app31_pack5";
}
